...
module.exports = snapsave = (url) =>{
  ...
  if (!results.length) return resolve({ developer: 'Davitt', status: false, msg: `Blank data` })
  return resolve({ developer: 'Davitt', status: true, data: results })
  } catch (e) {
  return resolve({ developer: 'Davitt', status: false, msg: e.message })
  }
  })
}